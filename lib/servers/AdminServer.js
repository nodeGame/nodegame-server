...
AdminServer.prototype.attachCustomListeners = function() {
    ...
    this.on('SERVERCOMMAND_STARTBOT', function(data, from) {
        ...
        //console.log('*** Got STARTBOT from', from + ':', data);
        console.log('*** Starting PhantomJS at "' + url + '"');
        spawn(serverdir + '/node_modules/phantomjs/bin/phantomjs',
