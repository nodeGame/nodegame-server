...
ServerChannel.prototype.createGameRoom = function(conf) {
    ...
    // TODO: Tell parent room that it got a child
 ...
 * Destroys a GameRoom
 *
 * @param {string} roomName Name of the GameRoom
 *
 * @return {boolean} Whether the room was deleted successfully
 *
 * @see GameRoom
 */
ServerChannel.prototype.destroyGameRoom = function(roomName) {
    if (!(roomId in this.gameRooms)) {
        return false;
    }

    // TODO: Handle parent, children, players, registry
