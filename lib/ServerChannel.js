 ...
 *
 * @param {string} queryString Optional. String of query parameters to append
 *   to the URL. Default: '?clientType=autoplay'.
 * @param {array} phantomjsArgs Optional. Array of strings to give to PhantomJS
 *   as command line arguments.
 *
 * @return {ChildProcess} Handle to the PhantomJS process
 */
ServerChannel.prototype.connectPhantom = function(queryString, phantomjsArgs) {
    var serverdir;
    var url;
    var phantomjs;
    var logger;
    ...
    url = 'http://localhost:' + this.servernode.port + '/' + this.name +
        '/' + queryString;
