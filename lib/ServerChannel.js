 ...
 *
 * @param {string} roomName Name of the GameRoom to destroy
 * @param {string|null} substituteRoomName Name of the GameRoom to move
...
ServerChannel.prototype.destroyGameRoom = function(roomName, substituteRoomName) {
    ...
    for (i in roomObj.childRooms) {
        ...
        if (roomObj.hasOwnProperty(i) && childName in this.gameRooms) {
            // Tell child:
