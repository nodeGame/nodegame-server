...
var SocketIo = require('./sockets/SocketIo'),
...
function GameServer(options) {
	...
	//this.log = this.sio.loggers.get('channel');
...
GameServer.prototype.listen = function() {
	...
	sio.attachListeners();
	this.gmm.socket_manager.registerSocket('sio', sio);
	
	
	var direct = new SocketDirect(this);
	this.gmm.socket_manager.registerSocket('direct', direct);
...
GameServer.prototype.onConnect = function(client, socket) {
	this.gmm.socket_manager.registerClient(client, socket);
...
GameServer.prototype.attachListeners = function() {
	...
	this.gmm.socket_manager.attachListeners();
};
