 ...
 *
 * Primitive for creating a Garage, Waiting, and Requirements room
 *
 * @param {string} type 'Garage', 'Waiting', or 'Requirements'
 * @param {object} settings Optional. The settings for the constructor
 *   of the room
 *
...
ServerChannel.prototype.createRoom = function(type, settings) {
    ...
    if ('object' !== typeof settings) {
        throw new TypeError('ServerChannel.create' + type + 'Room: settings ' +
                            'must be object or undefined. Found: ' + settings);
    }
