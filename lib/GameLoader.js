...
GameLoader.prototype.loadAuthDir = function(directory, gameName) {
    ...
    // Store the secret directly in the channel and delete it from settings.
    if (settings.secret) {
        this.servernode.channels[gameName].secret = settings.secret;
        settings.secret = '***';
    }
