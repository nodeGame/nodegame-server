...
ChannelRegistry.prototype.addClient = function(clientId, clientObj) {
    ...
    if ('string' !== typeof clientId) {
        throw new TypeError('ChannelRegistry.addClient: error generating ' +
                            'clientId.');
    }
 ...
 * @experimental
 */
ChannelRegistry.prototype.tagNext = function(tag) {
    var client;
    debugger
    ...
    //   - and most importantly it is not saved with NDDB.saved
...
function generateClient(clientObj) {
    var client = new Player(clientObj);
