...
Logger.prototype.logMsg = function(gm, text) {
    ...
    // TODO: have a more uniform logged message.
    // Now incoming messages from SocketIo are (already) stringified,
    // from SocketDirect they are put into meta as object. It is messy.

    // TODO: use custom logging levels for winston.
...
//         }
        ...
        this.logger.log('foobar', text, meta);
    }
    else {
        // meta.data = gm.data;
        // or
        meta.message = text;
        this.logger.log('foobar', gm, meta);
    }
