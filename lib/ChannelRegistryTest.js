...
var pid1 = chReg.addClient({sid:'222'});
var pid2 = chReg.addClient({sid:'225'});
var pid3 = chReg.addClient({sid:'17'});
var pid4 = chReg.addClient({sid:'1', admin:true});
var pid5 = chReg.addClient({sid:'404', disconnected:true});
