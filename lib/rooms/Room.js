...
function Room(type, config) {
   ...
   /**
     ...
     */
    this.cacheDumpInterval = config.cacheDumpInterval || 1000;
     ...
     */
    this.logClients = false === config.logClients ?
        false : this.channel.logClients;
     ...
     */
    this.logClientsExtra =
        config.logClientsExtra || this.channel.logClientsExtra;
    ...
    this.logFilePath = (function(that) {
        ...
        return path.resolve(that.channel.getGameDir(),
