...
function WaitingRoom(config) {
    ...
    */
    ...
    /**
     * ### WaitingRoom.TREATMENT_DISPLAY_CB
     *
     ...
     * ```
     */
    this.TREATMENT_DISPLAY_CB = null;
    ...
    tmp = settings.TREATMENT_DISPLAY_CB;
...
WaitingRoom.prototype.parseSettings = function(settings) {
    ...
    if ('undefined' !== typeof tmp) {
        if ('function' !== typeof tmp) {
            throw new TypeError(where + 'TREATMENT_DISPLAY_CB must ' +
                                'be function. Found: ' + tmp);
        }
        this.TREATMENT_DISPLAY_CB = tmp;
    }
...
WaitingRoom.prototype.makeWidgetConfig = function() {
    var o = {
        ...
        treatmentDisplayCb: this.TREATMENT_DISPLAY_CB,
...
WaitingRoom.prototype.decideTreatment = function(t, idxInBatch) {
    ...
    if (t === 'treatment_weighted_random') {
