...
function WaitingRoom(config) {
    ...
    if (!this.logicPath) this.logicPath  = '../logics/wait.room';
 ...
 *
 * @param {function} callback Callback to be executed when pinging is completed.
        ...
        this.kickUnresponsivePlayers(function() {
            ...
            for (gameNumber = 0; gameNumber < numberOfGames; ++gameNumber) {
                ...
                if (!that.lastGameRoom || !that.DISPATCH_TO_SAME_ROOM) {
                    ...
                    that.lastGameRoom.setupGame(undefined, false, playerIds);
                    that.lastGameRoom.startGame(false, playerIds, true);
                }
