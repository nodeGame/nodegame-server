    ...
    doDispatch = function(msg, numberOfGames) {
        ...
        if (nPlayersToDispatch > this.GROUP_SIZE) {
            ...
            if (this.PLAYER_GROUPING) {
                ...
                if (groups.length !== numberOfGames) {
                    sysLogger.log(where + ' PLAYER_GROUPING did not return ' +
                                  'the expected number of groups: ' +
                                  groups.length + ' vs ' + numberOfGames,
                                  'error');
                    return;
                }
                // TODO: Concatenate the groups.
                // TODO: work with an array of ids, instead of the pList alsow
