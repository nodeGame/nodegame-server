...
//     if ('undefined' !== typeof settings.TEXTS) {
// 
//         if ('object' !== typeof settings.TEXTS) {
// 
//             throw new TypeError(where + 'TEXTS must be object' +
//                                 'or undefined. Found: ' + settings.TEXTS);
//         }
// 
//         for (t in settings.TEXTS) {
//             if ('string' !== typeof settings.TEXTS[t]) {
//              throw new TypeError(where + 'TEXTS.' + t + ' must be string ' +
//                                     'or undefined. Found: ' +
//                                     settings.TEXTS[t]);
//             }
//         }        
 ...
 * ## assignStringObj
 *
 * Assigns a propertyobject that must contains only strings
 *
 * The property in the object must be undefined or function, otherwise
 * an error will be raised.
 *
 ...
 *   'WaitingRoom.parseSettings: '.
 */
function assignStringObj(name, toObj, fromObj, where) {
    var t;
    if ('undefined' !== typeof fromObj[name]) {
        ...
        for (t in fromObj[name]) {
            if ('string' !== typeof fromObj[name][t]) {
                throw new TypeError(where + name +'.' + t + ' must be string ' +
                                    'or undefined. Found: ' + fromObj[name][t]);
            }
        }               
        toObj[name] = fromObj[name];
    }
