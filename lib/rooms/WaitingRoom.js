...
function WaitingRoom(config) {
    ...
    */
     ...
     *
     * If TRUE treatments are displayed in tiles in the waiting room
     */
    this.TREATMENT_TILES = true;

    /**
     * ### WaitingRoom.ADD_DEFAULT_TREATMENTS
     *
     * If TRUE treatments are displayed in tiles in the waiting room
     */
    this.ADD_DEFAULT_TREATMENTS = true;
...
WaitingRoom.prototype.makeWidgetConfig = function() {
    var o = {
        ...
        userDispatch: this.ALLOW_USER_DISPATCH,
