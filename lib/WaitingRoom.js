...
var StandardWaitingRoom = require('./waitingrooms/standard.room.js');
...
function WaitingRoom(config) {
     ...
     */
    this.logicPath = config.logicPath || 'standard';
...
WaitingRoom.prototype.setupGame = function(mixinConf) {
    ...
    // TODO: take into account different 'standard' waiting rooms.
    if (this.logicPath === 'standard') {
        game = new StandardWaitingRoom(settings, this, this.runtimeConf);
    }
    else {
        game = require(this.logicPath)(settings, this, this.runtimeConf);
    }
