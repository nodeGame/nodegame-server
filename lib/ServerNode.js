...
ServerNode.prototype.addGameDir = function(gameDir) {
    ...
    gameSettingsPath = gameDir + 'game.settings.js';
    try {
    ...
    for (t in treatments) {
        if  (treatments.hasOwnProperty(t)) {
            ...
            if (treatment.logicPath) {
                ...
                gameLogicPath = gameDir + treatment.logicPath;
                try {
            ...
            if (treatment.clientPath) {
                ...
                gameClientPath = gameDir + treatment.clientPath;
                try {
...
ServerNode.prototype.buildLanguagesObject = function(directory) {
    ...
    ctxPath = directory + '/view/context/';
