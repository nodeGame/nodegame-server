...
//     });
   ...
   //      console.log('ServeNode: CTRL-C are you sure you want to exit? Type CTRL-D to exit.');
   //      // throw new Error();
   //      process.exit(1);
   //      debugger;
   //  });
 ...
 *
 * Adds one or multiple game alias/es
 *
 * adds references to the `info.games` and `pager.games` objects.
 *
