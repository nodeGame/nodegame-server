...
function ServerNode(options) {
    ...
    /**
     * ## ServerNode.languages
     *
     * Array containing objects representing the available languages.
     *
     * Each object in the array provides the fields `name`, `shortName`,
     * `nativeName` and `flag`.
     *
     */
    this.languages = [];
...
ServerNode.prototype.init = function(options) {
    ...
    // Initializing languages. English is default.
