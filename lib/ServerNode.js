...
ServerNode.prototype.addGame = function(gameInfo, treatments, gameDir) {
    ...
    this.info.games[gameInfo.name] = {
        ...
        languages: this.buildLanguagesArray(gameDir)
    };
...
/**
 * ### ServerNode.buildLanguagesArray
 *
 * Builds an array of language objects for a given game directory
 *
 * @param {object} directory The directory of the game.
 */
ServerNode.prototype.buildLanguagesArray = function(directory) {
    var ctxPath = directory + '/html/context/',
        langPaths = fs.readdirSync(ctxPath),
        languages, pathIndex, languageObject;
