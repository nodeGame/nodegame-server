 ...
 * @see ServerNode.addGame
 */
ServerNode.prototype.parseGameSettings = function(settingsObj) {
    var standard, t, out;
    var treatments;
    if ('object' !== typeof settingsObj) {
        throw new TypeError('ServerNode.parseGameSettings: settingsObj ' +
                            'must be object.');
    }
...
ServerNode.prototype.loadAuthDir = function(directory, gameName) {
    ...
    fs.exists(authFile, function(exists) {
        ...
        require(authFile)(authObj, that.info.games[gameName].settings);
