 ...
 * @param {object} gameSettings The game settings as in channel
 */
    ...
    fs.exists(contextPath, function(exists) {
        if (exists) {
            try {
                ...
                resourceManager
                    .servernode
                    .logger.error('renderTemplate: error loading ' +
 ...
 *
 * @param {object} res The respond object from Express
 * @param {string} cb The name of of the callback function that will
