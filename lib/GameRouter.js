...
function renderTemplate(resourceManager, req, res, channel,
    ...
    // By default, it is whole object (including treatments). If we
    ...
    gameSettings = channel.gameInfo.settings;
    if (req.cookies && req.cookies.nodegame_token) {
        ...
        if (clientId === false) {
            ...
            if (room && room.treatmentName) {
                gameSettings = gameSettings[room.treatmentName];
            }
        }
    }
