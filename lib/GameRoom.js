 ...
 *
 * Listener invoked at any time there is a wrong number of players connected
 *
 ...
 */
GameRoom.wrongNumOfPlayers = function(type, customCb, player) {
    var node;
 ...
 * @see GameRoom.getClientType
 */
GameRoom.correctNumOfPlayersAgain = function(type, customCb, player) {
    var node;
    node = this.node;
    if (type === 'min') {
