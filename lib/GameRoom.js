...
function GameRoom(config) {
    ...
    node.on.preconnect(function(p) {
        ...
        if ('number' === typeof milliseconds) {
            ...
            node.remoteSetup('plot', p.id, { timer: resetTime }, 'updateStep');
        }
...
GameRoom.prototype.getClientType = function(type, mixinConf) {
    ...
    function wrongNumOfPlayers(type, customCb, player) {
        var node;
    ...
    function correctNumOfPlayersAgain(type, customCb, player) {
